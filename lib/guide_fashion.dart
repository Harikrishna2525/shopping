...
class guid extends StatefulWidget {
  ...
  @override
  State<guid> createState() => _guidState();
}
          ...
          children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: NetworkImage("https://cdn.shopify.com/s/files/1/0094/0716/8559/files/silvertissue_oks31-half.jpg?v=1695874270&width=900"),fit: BoxFit.fill
                      ),
                      color: Colors.blue,
            ...
            Align(
                ...
                child: Padding(
                  ...
                  child: Text("Dhoti & Sarees",style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.w600),),
                )),
            Align(
                alignment: Alignment.topLeft,
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(" ₹ 4999.00",style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.w600)),
                )),
            Align(
                alignment: Alignment.topLeft,
                child: Padding(
